...
<table width="60%" height="60%" border="0" align="center" cellpadding="1" cellspacing="0">
  <tr> 
    <td><table width="100%" height="197" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
          ...
          <tr class="back"> 
            <td height="145" class="hback"> 
              ...
              <span class="tx"><strong>操作描述：</strong></span> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="12%" height="10"><div align="center"><span class="tx"><font style="font-size:30px"><strong>√</strong></font></span></div></td>
                  <td width="88%">
                      <div align="left"> 
                        <% = p_ErrCodes %>
                        <li><a href="<% =  p_ErrorUrl %>">返回上一级</a> </li>
                        <li><a href="http://www.foosun.cn" target="_blank">Powered 
                          by Foosun Inc.</a>　<a href="http://help.foosun.net" target="_blank" style="CURSOR:help">帮助中心</a> 
                          　<a href="http://bbs.foosun.net" target="_blank">技术论坛</a></li>
                    </div>
                    </td>
                </tr>
              </table>
