  ...
  <tr> 
    <td><table width="100%" height="182" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
        <form action="../../../CheckLogin.asp"  method="post" name="myform" id="myform"  onsubmit="return CheckForm();">
          <tr class="back"> 
            <td width="100%" height="24" class="xingmu">错误的参数</td>
          </tr>
          <tr class="back"> 
            <td height="130" class="hback"> 
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td width="12%" height="10"><div align="center"><span class="tx"><font style="font-size:30px;face:Arial, Helvetica, sans-serif"><strong>× </strong></font></span></div></td>
