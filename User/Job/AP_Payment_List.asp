...
Function Get_While_Info(Add_Sql)
	...
	Str_Tmp = "PID,PayDate,PayMoney,PayCount,LeftCount"
	This_Fun_Sql = "select "&Str_Tmp&" from FS_AP_Payment where UserNumber = '"&Session("FS_UserNumber")&"'"
	if 1=2 then
	...
	if PublicDate<>"" then New_Search_Str = and_where(New_Search_Str) & "PayDate "&PublicDate
	if EndDate<>"" then New_Search_Str = and_where(New_Search_Str) & "PayDate "&EndDate
	...
	Ap_Rs.AbsolutePage=cPageNo
	  ...
	  FOR int_Start=1 TO int_RPP 
		...
		Get_Html = Get_Html & "<td align=""center"">"&Ap_Rs("PID")&"</td>" & vbcrlf
		Get_Html = Get_Html & "<td align=""center"">"&Ap_Rs("PayDate")&"</td>" & vbcrlf
		Get_Html = Get_Html & "<td align=""center"">"&Ap_Rs("PayMoney")&"</td>" & vbcrlf
		Get_Html = Get_Html & "<td align=""center"">"&Ap_Rs("PayCount")&"</td>" & vbcrlf
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
   <tr  class="hback"> 
      <td align="center" class="xingmu" ><a href="javascript:OrderByName('PID')" class="sd"><b>序号</b></a> 
        <span id="Show_Oder_PID"></span></td>
      <td align="center" class="xingmu"><a href="javascript:OrderByName('PayDate')" class="sd"><b>充值日期</b></a> 
        <span id="Show_Oder_PayDate"></span></td>
      <td align="center" class="xingmu"><a href="javascript:OrderByName('PayMoney')" class="sd"><b>充值金额</b></a> 
        <span id="Show_Oder_PayMoney"></span></td>
      <td align="center" class="xingmu"><a href="javascript:OrderByName('PayCount')" class="sd"><b>相应点数</b></a> 
        <span id="Show_Oder_PayCount"></span></td>
      <td align="center" class="xingmu"><a href="javascript:OrderByName('LeftCount')" class="sd"><b>充值后点数</b></a> 
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
  <form name="form1" method="get" onSubmit="return chkinput();">
	<tr  class="hback"> 
            <td width="200" align="right">充值日期起始日期</td>
      <td>
