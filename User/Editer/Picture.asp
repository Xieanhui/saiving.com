        ...
        <table border="0" align=center cellpadding="0" cellspacing="3">
          <tr> 
            <td colspan="2">图片地址： 
              ...
              <input type="button" name="Button" value="选择图片" onClick="var TempReturnValue=OpenWindow('/<%=G_USER_DIR %>/CommPages/SelectPic.asp?CurrPath=<% = str_CurrPath %>&f_UserNumber=<% = session("FS_UserNumber")%>',500,290,window);if (TempReturnValue!='') document.PicForm.url.value='<% = DirectoryRoot %>'+TempReturnValue;" class=Anbutc> 
            </td>
          </tr>
          <tr> 
            <td> 说明文字： 
