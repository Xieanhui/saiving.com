    ...
    <td align="center"> 
      <LEGEND align=left></LEGEND> <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <input type="button" name="Button" value="选择附件" onClick="var TempReturnValue=OpenWindow('/<%=G_USER_DIR %>/CommPages/SelectPic.asp?CurrPath=<% = str_CurrPath %>&f_UserNumber=<% = session("FS_UserNumber")%>',500,290,window);setFileInfo(TempReturnValue);" class=Anbutc></td>
        </tr>
      </table></td>
