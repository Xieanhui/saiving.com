    ...
    <tr> 
      <td><div align="center"> 
          <%
			...
			Rss_List = Rss_List &  "	<link>http://www.foosun.net</link>"&sCrLf
			...
			Rss_List = Rss_List &  "		<title>风讯</title>"&sCrLf
			Rss_List = Rss_List &  "		<link>http://www.foosun.net</link>"&sCrLf
			Rss_List = Rss_List &  "		<url>http://www.foosun.net/logo/logo8831.gif</url>"&sCrLf
			Rss_List = Rss_List &  "	</image>"&sCrLf
			Call GetFunctionstr
					...
					if Trim(Request("Editor")) <>"" then:str_Editor = " and Editor = '"& NoSqlHack(Request("Editor"))&"'":Else:str_Editor = "":End if
					...
					if not obj_newslist_rs.eof then
						...
						if obj_newslist_rs("isUrl")=1 then
							...
							'Rss_List = Rss_List & "<description><![CDATA[标题新闻,无内容]></description>"&sCrLf 
						Else
