...
If Str_NS_NewsClassID<>"" Then
	StrSql="SELECT Templet FROM FS_NS_NewsClass WHERE ReycleTF=0 AND ClassID='"&Str_NS_NewsClassID&"'"
...
End If
Response.Write Get_Dynamic_Refresh_Content(Str_NS_NewsClass_Templet,Str_NS_NewsClassID,"NS",Page,"class")
%>