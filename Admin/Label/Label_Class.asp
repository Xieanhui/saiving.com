...
<table width="98%" height="76" border="0" align="center" cellpadding="4" cellspacing="1" class="table">
  ...
  <tr class="hback" > 
	...
	do while not rs_class.EOF
		response.Write "├"&rs_class("ClassName")&"&nbsp;&nbsp;<a href=Label_Class.asp?id="&rs_class("id")&"&action=edit>[修改]</a><a href=Label_Class.asp?id="&rs_class("id")&"&action=del onClick=""{if(confirm('确定清除您所选择的记录吗？\n删除后，此栏目下的标签将放到根目录下！')){return true;}return false;}"">[删除]</a><br />"
...
<table width="98%" height="76" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
  ...
  <form name="form1" method="post" action=""><tr class="hback" >
    ...
    <tr class="hback" >
      <td align="center" class="hback">所属栏目</td>
  ...
  <tr class="hback" >
    ...
    <td align="center" class="hback"><div align="left">
      <label>
      <input type="submit" name="Submit" value="创建标签分类">
      </label>
      <label>
...
If request.Form("Action")<>"" then
	...
	if Request.Form("Action")="Add_Save" then
		wheresql = " where 1=0"
		strShowErr = "<li>创建分类成功</li><li><a href=Label/Label_Class.asp>继续创建</a></li><li><a href=Label/All_Label_Stock.asp>返回管理</A></li>"
	elseif Request.Form("Action")="Edit_Save" then
		strShowErr = "<li>修改分类成功</li><li><a href=Label/Label_Class.asp?id="&Request.Form("Id")&"&action=edit>继续修改</a></li><li><a href=Label/All_Label_Stock.asp>返回管理</A></li>"
...
Function get_childList1(TypeID,f_CompatStr)  
	...
	f_TempStr =f_CompatStr & "┄"
	do while Not f_ChildNewsRs.Eof
			get_childList1 = get_childList1 & "├" &  f_TempStr &f_ChildNewsRs("ClassName") &"&nbsp;&nbsp;<a href=Label_Class.asp?id="&f_ChildNewsRs("id")&"&action=edit>[修改]</a><a href=Label_Class.asp?id="&f_ChildNewsRs("id")&"&action=del onClick=""{if(confirm('确定清除您所选择的记录吗？\n删除后，此栏目下的标签将放到根目录下！')){return true;}return false;}"">[删除]</a><br />"
