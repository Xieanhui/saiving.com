...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" class="leftframetable">
  <tr allparentid="OrdinaryMan" parentid="OrdinaryMan" classid="RecyleManage"> 
    ...
    <td colspan="2" class="titledaohang">下载系统</td>
  </tr>
  ...
  <tr allparentid="OrdinaryMan" parentid="OrdinaryMan" classid="VoteManage" style="display:;"> 
    ...
    <td height="22" colspan="2"><a href="FS_DS_SysPara.asp" target="ContentFrame" class="lefttop">参数设置</a></td>
  </tr>
  <%
  end if
  ...
  <tr allparentid="OrdinaryMan" parentid="OrdinaryMan" classid="VoteManage" style="display:;"> 
    <td width="3%"><div align="center"><img src="../Images/Folder/folderclosed.gif"></div></td>
    <td height="22" colspan="2"><a href="Class_Manage.asp" target="ContentFrame" class="lefttop">栏目管理</a></td>
  </tr>
  <%
  end if
  ...
  <tr allparentid="OrdinaryMan" parentid="OrdinaryMan" classid="VoteManage" style="display:;"> 
    <td width="3%"><div align="center"><img src="../Images/Folder/folderclosed.gif"></div></td>
    <td height="22" colspan="2"><a href="DownloadList.asp" target="ContentFrame" class="lefttop">下载管理</a></td>
  </tr>
  <%end if%>
  <tr allparentid="OrdinaryMan" parentid="OrdinaryMan" classid="VoteManage" style="display:;"> 
