...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
  ...
  <tr> 
    <td height="18" class="hback"><div align="left"><a href="Class_ToTemplet.asp">管理首页</a> 
        &nbsp;|&nbsp; <a href="Class_ToTempletRead.asp">栏目模板查看</a> | <a  href="#" onClick="javascirp:history.back()">&nbsp;后退</div></td>
  </tr>
</table>
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
  <form name="ClassForm" method="post" action="Class_Action.asp">
    <tr class="xingmu"> 
      ...
      <td width="37%" class="xingmu">下载模板</td>
    </tr>
    <%
	Dim obj_news_rs,obj_news_rs_1,isUrlStr
	Set obj_news_rs = server.CreateObject(G_FS_RS)
	obj_news_rs.Open "Select Orderid,id,ClassID,ClassName,ClassEName,IsUrl,Templet,NewsTemplet from FS_DS_Class where Parentid  = '0'   and ReycleTF=0  Order by Orderid desc,ID desc",Conn,1,3
    ...
    <tr class="hback"> 
      <td height="22" class="hback"> <% 
		...
		obj_news_rs_1.Open "Select Count(ID) from FS_DS_Class where ParentID='"& NoSqlHack(obj_news_rs("ClassID")) &"'",Conn,1,1
...
<%
	Function GetChildNewsList(TypeID,CompatStr)  
		...
		Set ChildNewsRs = Conn.Execute("Select id,orderid,ClassName,ClassEName,ClassID,IsUrl,NewsTemplet,Templet from FS_DS_Class where ParentID='" & NoSqlHack(TypeID) & "'  and ReycleTF=0  order by Orderid desc,id desc" )
