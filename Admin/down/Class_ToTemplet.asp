...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
  <tr class="hback"> 
    <td class="xingmu"><a href="#" class="sd"><strong>模板管理</strong></a><a href="../../help?Lable=DS_Class_Templet" target="_blank" style="cursor:help;'" class="sd"><img src="../Images/_help.gif" border="0"></a></td>
  </tr>
  <tr> 
    <td height="18" class="hback"><div align="left"><a href="Class_ToTemplet.asp">首页</a> 
        &nbsp;|&nbsp; <a href="Class_ToTempletRead.asp">栏目模板查看</a>&nbsp;|<a  href="#" onClick="javascirp:history.back()">&nbsp;&nbsp;后退</a></div></td>
  </tr>
</table>
