...
Class Cls_News
   ...
   Public Function chkinputchar(f_char)
	...
	Public Property Get IPType()				'站点关键字  
		IPType = m_IPType
	End Property 
	Public Property Get IPList()				'下载系统前台目录 
		IPList = m_IPList
	End Property 
	...
	End Property 
		Public Property Get newsCheck()				'发布的下载是否需要审核 
